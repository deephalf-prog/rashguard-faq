      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Deep Half</h3>
            <p className="text-gray-400 mb-4">
              Premium BJJ rashguards designed for performance and style. Join the waitlist to be the first to know when we launch.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/specs" className="text-gray-300 hover:text-white">
                  Specs
                </Link>
              </li>
            </ul>
